@role('admin')
    ...
    <li class="nav-item {{ Request::is('admin/categories*') ? 'active' : '' }}" wire:ignore>
        <a class="nav-link d-flex align-items-center py-3" aria-current="page" href="{{ route('category.index') }}" wire:ignore target="_blank">
            <span class="menu-icon">
