<div class="row gx-10 mb-5">
    ...
    <div class="col-lg-4">
        <div class="mb-5">
            ...
            {{ Form::number('unit_price', null, ['id' => 'unitPriceId', 'class' => 'form-control', 'placeholder' => __('messages.product.unit_price'), 'oninput' => "validity.valid||(value=value.replace(/\D+/g, '.'))"]) }}
        </div>
    </div>
    <div class="col-lg-4">
        <div class="mb-5">
