<div class="row">
    ...
    <div class="col-lg-4 col-sm-12 mb-5">
        {{ Form::label('costing', __('Costing') . ':', ['class' => 'form-label  mb-3']) }}
        {{ Form::text('costing', null, ['class' => 'form-control', 'id' => 'costing', 'autocomplete' => 'off']) }}
    </div>
    <div class="col-lg-4 col-sm-12 mb-5">
            ...
            <table class="table table-striped box-shadow-none mt-4" id="billTbl">
                ...
                <tbody class="invoice-item-container">
                    <tr class="tax-tr">
                        ...
                        <td>
                            {{ Form::number('price[]', null, ['class' => 'form-control price-input price ', 'oninput' => "validity.valid||(value=value.replace(/[e\+\-]/gi,''))", 'pattern' => "^\d*(\.\d{0,2})?$", 'required', 'onKeyPress' => 'if(this.value.length==8) return false;']) }}
                        </td>
                        <td>
