...
<div class="row mb-2">
    ...
    <div class="mt-5 col-lg-3 col-sm-12 d-none">
        ...
        <table class="table table-striped box-shadow-none mt-4" id="billTbl">
            <thead>
                <tr class="border-bottom fs-7 fw-bolder text-gray-700 text-uppercase">
                    ...
                    <th scope="col" class="required">{{ __('Variation') }}</th>
            ...
            <tbody class="invoice-item-container">
                ...
                @foreach ($invoice->invoiceItems as $invoiceItem)
                    <tr class="tax-tr">
                        ...
                        <td class="table__item-desc w-25">
                            {{ Form::select('variations[]', getvariation(), $invoiceItem->variations, ['class' => 'form-select product variations io-select2', 'required', 'placeholder' => __('Variations'), 'data-control' => 'select2']) }}
                        </td>
                        <td class="table__qty">
                            {{ Form::number('quantity[]', $invoiceItem->quantity, ['class' => 'form-control qty ', 'id' => 'qty', 'required', 'type' => 'number', 'min' => '0', 'step' => '.01', 'oninput' => "validity.valid||(value=value.replace(/[e\+\-]/gi,''))"]) }}
                        </td>
                        <td>
