...
<tr class="border-bottom border-bottom-dashed tax-tr">
    ...
    <td>
        <input class="form-control price-input price " required="" name="price[]" type="number" oninput="validity.valid||(value=value.replace(/[e\+\-]/gi,''))"  onKeyPress="if(this.value.length==8) return false;">
    </td>
    <td class="">
